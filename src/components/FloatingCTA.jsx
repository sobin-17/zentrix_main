  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-[44px] h-[44px] md:w-[52px] md:h-[52px] rounded-2xl bg-gradient-to-br from-[#6366F1] to-[#8B5CF6] shadow-[0_4px_15px_rgba(99,102,241,0.35)] hover:shadow-[0_0_25px_rgba(99,102,241,0.65)] transition-all duration-300 hover:scale-110"
        title="WhatsApp Us"
      >
      ...
      <a
        ...
        className="group relative flex items-center justify-center w-[44px] h-[44px] md:w-[52px] md:h-[52px] rounded-2xl bg-gradient-to-br from-[#8B5CF6] to-[#A855F7] shadow-[0_4px_15px_rgba(139,92,246,0.35)] hover:shadow-[0_0_25px_rgba(139,92,246,0.65)] transition-all duration-300 hover:scale-110"
        title="Call Us"
      >
      ...
      <Link
        to="/course"
        className="group relative flex flex-col items-center justify-center w-[44px] h-[44px] md:w-[52px] md:h-[52px] rounded-2xl bg-gradient-to-br from-[#A855F7] to-[#EC4899] shadow-[0_4px_15px_rgba(168,85,247,0.35)] hover:shadow-[0_0_25px_rgba(168,85,247,0.65)] transition-all duration-300 hover:scale-110"
      >
        <GraduationCap className="w-4 h-4 md:w-5 md:h-5 mb-0 text-white" />
        <span className="text-[8px] md:text-[9px] font-bold tracking-wider text-white">
          ENROLL
        </span>
